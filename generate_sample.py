...
from models import Generator  # Import your Generator2 model definition

def generate_samples(model_path, output_path, z_dim=1000, num_samples=1):

    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    generator = Generator(z_dim=z_dim, image_channels=3).to(device)
...
model_path = 'model_saved/generator_model3.pth' 
output_path = 'samples/generated_samples3.png'  
num_samples = 1              
